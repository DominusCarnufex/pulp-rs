...
// Le nom du segment a une taille de 0, ce qui n’est pas
// acceptable.
#[test]
#[should_panic(expected = "taille du nom doit")]
fn bad_segment_name_size()  {
    let vec = vec![
        0x15, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00,
        0x00,
...
// l’UTF-8 valide.
#[test]
#[should_panic(expected = "UTF-8 invalide dans le nom")]
fn bad_segment_name()   {
    let vec = vec![
        0x19, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00,
...
// Les deux segments s’appellent tous les deux `a`.
#[test]
#[should_panic(expected = "Deux segments portent le même identifiant")]
...
// La taille prétendue (23 octets) est supérieure à la
...
// Le symbole présent a une taille de 0, ce qui n’est pas
// acceptable.
#[test]
...
// l’UTF-8 valide.
#[test]
#[should_panic(expected = "UTF-8 invalide dans le symbole")]
